...
body {
	background-color: #778ca3; padding-left: 100px; padding-top: 30px;
...
<button style="background-color: #7700c9"><a href="updateLike?board_no=${boardDto.board_no}"><font color="ffffff" size="18">Like</font></a></button>
...
<th>게시글 조회수</th>
	...
	<td>${boardDto.board_readcount}</td>
			...
			<td><fmt:formatDate value="${boardDto.board_ctime}" pattern="y년 M월 d일 E요일 a h시 m분 s초"/></td>
			<td><fmt:formatDate value="${boardDto.board_utime}" pattern="y년 M월 d일 E요일 a h시 m분 s초"/></td>
		</tr>
	</table>
