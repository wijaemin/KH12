		...
		<c:when test="${dto != null}">
			<ul>
				...
				<c:forEach var="sizeDto" items="${sizeList}">
					<li>사이즈 : ${sizeDto.shirt_size_name}</li>
				</c:forEach>

			</ul>

			<img align="right" id="shirt_no=3" alt="뭐지"
				src="https://tistory1.daumcdn.net/tistory/2826541/attach/f3c51d35915945aba94d36eda4c78264">
			<h4>
