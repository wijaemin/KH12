...
public String toString() {
	return "bookDto [book_id=" + book_id + ", book_page_count=" + book_page_count + ", book_title=" + book_title
			...
			+ getBook_id() + ", getBook_page_count()=" + getBook_page_count() + ", getBook_title()=" + getBook_title()
			+ ", getBook_author()=" + getBook_author() + ", getBook_publisher()=" + getBook_publisher()
			+ ", getBook_genre()=" + getBook_genre() + ", getBook_pirce()=" + getBook_pirce()
